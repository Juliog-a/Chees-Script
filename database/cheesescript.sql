...
--
-- Host: localhost    Database: cheesescript
-- ------------------------------------------------------
...
--
-- Table structure for table `api_comentariopublicacion`
--

DROP TABLE IF EXISTS `api_comentariopublicacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_comentariopublicacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `api_comentariopublicacion_usuario_id_ae7193b9_fk_auth_user_id` (`usuario_id`),
  KEY `api_comentariopublic_publicacion_id_f4229a64_fk_api_publi` (`publicacion_id`),
  CONSTRAINT `api_comentariopublic_publicacion_id_f4229a64_fk_api_publi` FOREIGN KEY (`publicacion_id`) REFERENCES `api_publicacion` (`id`),
  CONSTRAINT `api_comentariopublicacion_usuario_id_ae7193b9_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_comentariopublicacion`
--

LOCK TABLES `api_comentariopublicacion` WRITE;
/*!40000 ALTER TABLE `api_comentariopublicacion` DISABLE KEYS */;
INSERT INTO `api_comentariopublicacion` VALUES (7,'hola que tal','2025-02-28 14:07:33.116002','guillermo',36,17),(8,'hola','2025-02-28 14:13:54.362435','julio',1,14),(9,'hola','2025-02-28 16:02:11.048138','julio',1,3),(10,'hola','2025-02-28 16:21:05.534771','julio',1,3),(11,'what','2025-02-28 16:25:52.872515','julio',1,5),(12,'sii','2025-02-28 16:26:18.479252','queso',35,12),(13,'asdddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd','2025-02-28 17:11:24.282566','queso',35,3),(14,'asdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasd','2025-02-28 17:13:03.961567','queso',35,3),(15,'gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg','2025-02-28 17:14:01.559564','queso',35,3);
/*!40000 ALTER TABLE `api_comentariopublicacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_desafio`
--

DROP TABLE IF EXISTS `api_desafio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_desafio` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `nombre` varchar(128) NOT NULL,
  `descripcion` longtext NOT NULL,
  `fecha_creacion` datetime(6) NOT NULL,
  `nivel_dificultad` varchar(64) NOT NULL,
  `tematica` varchar(64) NOT NULL,
  `hecho` tinyint(1) NOT NULL,
  `usuario_id` int NOT NULL,
  `puntuacion` int NOT NULL,
  `clave_cifrado` varchar(128) DEFAULT NULL,
  `enunciado` longtext,
  `solucion` varchar(256) DEFAULT NULL,
  `texto_cifrado` longtext,
  `tipo_cifrado` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `api_desafio_usuario_id_41b4385e_fk_auth_user_id` (`usuario_id`),
  CONSTRAINT `api_desafio_usuario_id_41b4385e_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_desafio`
--

LOCK TABLES `api_desafio` WRITE;
/*!40000 ALTER TABLE `api_desafio` DISABLE KEYS */;
INSERT INTO `api_desafio` VALUES (4,'El Misterio del Mensaje Perdido','Un agente secreto dejó un mensaje cifrado en su diario antes de desaparecer. Tu misión es descifrar el mensaje. Se rumorea que utilizó un cifrado relacionado con Roma.','2025-02-28 17:33:23.359673','Principiante','Cifrado',1,1,2,'Desplazamiento: +3','En 1943, un agente de inteligencia dejó un mensaje en su diario. Solo aquellos con habilidades en criptografía pueden descifrarlo. Sabemos que utilizó un cifrado de sustitución, pero no estamos seguros del desplazamiento exacto. ¿Podrás encontrar la clave y leer el mensaje?','Este es el mensaje','Hvwh hv hñ ohpvdmh','César');
/*!40000 ALTER TABLE `api_desafio` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_desafio_likes`
--

DROP TABLE IF EXISTS `api_desafio_likes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_desafio_likes` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `desafio_id` bigint NOT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_desafio_likes_desafio_id_user_id_7607eb3f_uniq` (`desafio_id`,`user_id`),
  KEY `api_desafio_likes_user_id_e6d091d4_fk_auth_user_id` (`user_id`),
  CONSTRAINT `api_desafio_likes_desafio_id_e628187a_fk_api_desafio_id` FOREIGN KEY (`desafio_id`) REFERENCES `api_desafio` (`id`),
  CONSTRAINT `api_desafio_likes_user_id_e6d091d4_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_desafio_likes`
--

LOCK TABLES `api_desafio_likes` WRITE;
/*!40000 ALTER TABLE `api_desafio_likes` DISABLE KEYS */;
INSERT INTO `api_desafio_likes` VALUES (61,4,1),(60,4,35);
/*!40000 ALTER TABLE `api_desafio_likes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_formulariocontacto`
--

DROP TABLE IF EXISTS `api_formulariocontacto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_formulariocontacto` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `autor` varchar(64) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `api_formulariocontacto_usuario_id_dea494aa_fk_auth_user_id` (`usuario_id`),
  CONSTRAINT `api_formulariocontacto_usuario_id_dea494aa_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_formulariocontacto`
--

LOCK TABLES `api_formulariocontacto` WRITE;
/*!40000 ALTER TABLE `api_formulariocontacto` DISABLE KEYS */;
INSERT INTO `api_formulariocontacto` VALUES (1,'julioblak36@gmail.com','asda','Pendiente','2025-02-19 19:09:40.244193',NULL),(2,'frodo@gmail.com','a ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si esto furulaa ver si e','Pendiente','2025-02-20 15:02:51.248445',NULL);
/*!40000 ALTER TABLE `api_formulariocontacto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_formulariofeedback`
--

DROP TABLE IF EXISTS `api_formulariofeedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_formulariofeedback` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `autor` varchar(64) NOT NULL,
  ...
  `usuario_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `api_formulariofeedback_desafio_id_288f8da6_fk_api_desafio_id` (`desafio_id`),
  KEY `api_formulariofeedback_usuario_id_d817b3b2_fk_auth_user_id` (`usuario_id`),
  CONSTRAINT `api_formulariofeedback_desafio_id_288f8da6_fk_api_desafio_id` FOREIGN KEY (`desafio_id`) REFERENCES `api_desafio` (`id`),
  CONSTRAINT `api_formulariofeedback_usuario_id_d817b3b2_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_formulariofeedback`
--

LOCK TABLES `api_formulariofeedback` WRITE;
/*!40000 ALTER TABLE `api_formulariofeedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_formulariofeedback` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `api_profile` VALUES (1,0,8,NULL),(2,35,9,NULL),(3,20,10,NULL),(4,100,11,NULL),(5,5,12,NULL),(6,250,13,NULL),(7,20,14,NULL),(8,25,15,NULL),(9,1,4,NULL),(10,100,7,NULL),(11,70,1,'https://cdn.pixabay.com/photo/2022/05/09/07/52/flamingo-7183937_1280.jpg'),(12,0,2,'https://cdn.pixabay.com/photo/2022/08/30/15/08/palace-7421313_1280.jpg'),(13,0,3,NULL),(14,0,5,NULL),(15,0,6,NULL),(16,0,16,NULL),(17,0,17,NULL),(18,0,18,NULL),(19,0,19,NULL),(20,0,20,NULL),(21,0,21,NULL),(22,0,22,NULL),(23,0,23,NULL),(24,0,24,NULL),(25,0,25,NULL),(26,0,26,NULL),(27,0,27,NULL),(28,0,28,NULL),(29,0,29,'https://cdn.pixabay.com/photo/2022/08/30/15/08/palace-7421313_1280.jpg'),(30,0,30,NULL),(31,0,31,NULL),(32,0,32,'https://cdn.pixabay.com/photo/2022/08/30/15/08/palace-7421313_1280.jpg'),(33,0,33,'https://cdn.pixabay.com/photo/2022/08/30/15/08/palace-7421313_1280.jpg'),(34,0,34,NULL),(35,5,35,NULL),(36,0,36,'https://images.pexels.com/photos/28955424/pexels-photo-28955424.jpeg'),(40,0,40,NULL),(41,0,41,NULL);
/*!40000 ALTER TABLE `api_profile` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_publicacion`
--

DROP TABLE IF EXISTS `api_publicacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_publicacion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `usuario_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `api_publicacion_usuario_id_926c05bd_fk_auth_user_id` (`usuario_id`),
  CONSTRAINT `api_publicacion_usuario_id_926c05bd_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_publicacion`
--

LOCK TABLES `api_publicacion` WRITE;
/*!40000 ALTER TABLE `api_publicacion` DISABLE KEYS */;
INSERT INTO `api_publicacion` VALUES (3,'Mi publicación desde MySQL','Este es un post de prueba.','2025-02-25 17:18:13.000000','https://imgs.search.brave.com/mEeF2tabBKxCdtMXYJDtNsn9x2-H9mg0mES3Me_AaU0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9waXhs/ci5jb20vaW1hZ2Vz/L2dlbmVyYXRvci9o/b3ctdG8tZ2VuZXJh/dGUud2VicA',2),(5,'veamos','estoy molesto con la mesa','2025-02-27 17:10:14.885577',NULL,1),(12,'pruebapruebapruebapruebapruebapr','pruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebapruebaprue','2025-02-28 10:54:01.642014','https://images.pexels.com/photos/28955424/pexels-photo-28955424.jpeg',1),(14,'pruebade eliminar','a ver como sale','2025-02-28 11:32:46.734180','',35),(17,'me gusta elñ arroz','hola','2025-02-28 14:07:24.477738','https://images.pexels.com/photos/28955424/pexels-photo-28955424.jpeg',36);
/*!40000 ALTER TABLE `api_publicacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_publicacion_likes`
--

DROP TABLE IF EXISTS `api_publicacion_likes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_publicacion_likes` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `publicacion_id` bigint NOT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_publicacion_likes_publicacion_id_user_id_a0c02efe_uniq` (`publicacion_id`,`user_id`),
  KEY `api_publicacion_likes_user_id_fc9e8c87_fk_auth_user_id` (`user_id`),
  CONSTRAINT `api_publicacion_like_publicacion_id_69981111_fk_api_publi` FOREIGN KEY (`publicacion_id`) REFERENCES `api_publicacion` (`id`),
  CONSTRAINT `api_publicacion_likes_user_id_fc9e8c87_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_publicacion_likes`
--

LOCK TABLES `api_publicacion_likes` WRITE;
/*!40000 ALTER TABLE `api_publicacion_likes` DISABLE KEYS */;
INSERT INTO `api_publicacion_likes` VALUES (20,3,1),(10,3,35),(21,5,1),(19,12,1),(25,14,1),(24,14,35);
/*!40000 ALTER TABLE `api_publicacion_likes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_recursosdidacticos`
--

DROP TABLE IF EXISTS `api_recursosdidacticos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_recursosdidacticos` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tipo` varchar(10) NOT NULL,
  `url_contenido` varchar(256) NOT NULL,
  `fecha_publicacion` datetime(6) NOT NULL,
  `desafio_id` bigint NOT NULL,
  `nombre` varchar(100) NOT NULL,
  `contenido` longtext,
  PRIMARY KEY (`id`),
  KEY `api_recursosdidacticos_desafio_id_548bf84a_fk_api_desafio_id` (`desafio_id`),
  CONSTRAINT `api_recursosdidacticos_desafio_id_548bf84a_fk_api_desafio_id` FOREIGN KEY (`desafio_id`) REFERENCES `api_desafio` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_recursosdidacticos`
--

LOCK TABLES `api_recursosdidacticos` WRITE;
/*!40000 ALTER TABLE `api_recursosdidacticos` DISABLE KEYS */;
INSERT INTO `api_recursosdidacticos` VALUES (5,'teoria','http://localhost:5173/teoria/4/cifrado-cesar','2025-03-01 09:53:09.944063',4,'Cifrado César','¿Qué es el Cifrado César?\r\nEl Cifrado César es un método de cifrado por sustitución en el que cada letra del texto original es desplazada un número fijo de posiciones en el alfabeto.\r\n\r\nEjemplo con desplazamiento de +3:\r\nTexto original: HOLA\r\nTexto cifrado: KROD\r\nCada letra ha sido desplazada 3 posiciones hacia la derecha en el alfabeto:\r\n\r\nH → K\r\nO → R\r\nL → O\r\nA → D\r\nCómo descifrar un mensaje\r\nPara descifrarlo, simplemente desplazamos cada letra en sentido contrario al usado para cifrar.\r\n\r\nSi el mensaje cifrado es KROD y sabemos que el desplazamiento fue +3, entonces para descifrarlo desplazamos -3:\r\n\r\nK → H\r\nR → O\r\nO → L\r\nD → A\r\nEl texto original era HOLA.\r\n\r\n¿Dónde se usa el Cifrado César?\r\nEn mensajes secretos de la antigua Roma (usado por Julio César).\r\nEn desafíos de seguridad y criptografía básica.\r\nEn algunos sistemas de ofuscación de datos.'),(6,'pista','http://localhost:5173/pista/4/encuentra-el-desplazamiento-correcto','2025-03-01 09:54:05.929164',4,'Encuentra el Desplazamiento Correcto','Para descifrar el mensaje, debes encontrar el número de posiciones con las que se desplazaron las letras.\r\n\r\nPrueba desplazando las letras hacia atrás en el alfabeto, usando diferentes valores (por ejemplo, -1, -3, -5) hasta encontrar el mensaje correcto.\r\n\r\nSi el texto cifrado es:\r\n\r\nZHOFRPH WR WKH FKDOOHQJH\r\n\r\nPrueba desplazar cada letra en sentido contrario hasta descubrir el mensaje original.');
/*!40000 ALTER TABLE `api_recursosdidacticos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_snippet`
--

DROP TABLE IF EXISTS `api_snippet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_snippet` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `usuario_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `api_snippet_usuario_id_7c666477_fk_auth_user_id` (`usuario_id`),
  CONSTRAINT `api_snippet_usuario_id_7c666477_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_snippet`
--

LOCK TABLES `api_snippet` WRITE;
/*!40000 ALTER TABLE `api_snippet` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_snippet` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `api_usuariodesafio`
--

DROP TABLE IF EXISTS `api_usuariodesafio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_usuariodesafio` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fecha_completado` datetime(6) NOT NULL,
  `desafio_id` bigint NOT NULL,
  `usuario_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_usuariodesafio_usuario_id_desafio_id_fbf5ab10_uniq` (`usuario_id`,`desafio_id`),
  KEY `api_usuariodesafio_desafio_id_49b2e207_fk_api_desafio_id` (`desafio_id`),
  CONSTRAINT `api_usuariodesafio_desafio_id_49b2e207_fk_api_desafio_id` FOREIGN KEY (`desafio_id`) REFERENCES `api_desafio` (`id`),
  CONSTRAINT `api_usuariodesafio_usuario_id_c69ff2bf_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_usuariodesafio`
--

LOCK TABLES `api_usuariodesafio` WRITE;
/*!40000 ALTER TABLE `api_usuariodesafio` DISABLE KEYS */;
INSERT INTO `api_usuariodesafio` VALUES (1,'2025-02-28 18:16:05.562771',4,35);
/*!40000 ALTER TABLE `api_usuariodesafio` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `auth_permission` VALUES (1,'Can add log entry',1,'add_logentry'),(2,'Can change log entry',1,'change_logentry'),(3,'Can delete log entry',1,'delete_logentry'),(4,'Can view log entry',1,'view_logentry'),(5,'Can add permission',2,'add_permission'),(6,'Can change permission',2,'change_permission'),(7,'Can delete permission',2,'delete_permission'),(8,'Can view permission',2,'view_permission'),(9,'Can add group',3,'add_group'),(10,'Can change group',3,'change_group'),(11,'Can delete group',3,'delete_group'),(12,'Can view group',3,'view_group'),(13,'Can add user',4,'add_user'),(14,'Can change user',4,'change_user'),(15,'Can delete user',4,'delete_user'),(16,'Can view user',4,'view_user'),(17,'Can add content type',5,'add_contenttype'),(18,'Can change content type',5,'change_contenttype'),(19,'Can delete content type',5,'delete_contenttype'),(20,'Can view content type',5,'view_contenttype'),(21,'Can add session',6,'add_session'),(22,'Can change session',6,'change_session'),(23,'Can delete session',6,'delete_session'),(24,'Can view session',6,'view_session'),(25,'Can add desafio',7,'add_desafio'),(26,'Can change desafio',7,'change_desafio'),(27,'Can delete desafio',7,'delete_desafio'),(28,'Can view desafio',7,'view_desafio'),(29,'Can add formulario contacto',8,'add_formulariocontacto'),(30,'Can change formulario contacto',8,'change_formulariocontacto'),(31,'Can delete formulario contacto',8,'delete_formulariocontacto'),(32,'Can view formulario contacto',8,'view_formulariocontacto'),(33,'Can add formulario feedback',9,'add_formulariofeedback'),(34,'Can change formulario feedback',9,'change_formulariofeedback'),(35,'Can delete formulario feedback',9,'delete_formulariofeedback'),(36,'Can view formulario feedback',9,'view_formulariofeedback'),(37,'Can add publicacion',10,'add_publicacion'),(38,'Can change publicacion',10,'change_publicacion'),(39,'Can delete publicacion',10,'delete_publicacion'),(40,'Can view publicacion',10,'view_publicacion'),(41,'Can add comentario publicacion',11,'add_comentariopublicacion'),(42,'Can change comentario publicacion',11,'change_comentariopublicacion'),(43,'Can delete comentario publicacion',11,'delete_comentariopublicacion'),(44,'Can view comentario publicacion',11,'view_comentariopublicacion'),(45,'Can add recursos didacticos',12,'add_recursosdidacticos'),(46,'Can change recursos didacticos',12,'change_recursosdidacticos'),(47,'Can delete recursos didacticos',12,'delete_recursosdidacticos'),(48,'Can view recursos didacticos',12,'view_recursosdidacticos'),(49,'Can add snippet',13,'add_snippet'),(50,'Can change snippet',13,'change_snippet'),(51,'Can delete snippet',13,'delete_snippet'),(52,'Can view snippet',13,'view_snippet'),(53,'Can add profile',14,'add_profile'),(54,'Can change profile',14,'change_profile'),(55,'Can delete profile',14,'delete_profile'),(56,'Can view profile',14,'view_profile'),(57,'Can add usuario desafio',15,'add_usuariodesafio'),(58,'Can change usuario desafio',15,'change_usuariodesafio'),(59,'Can delete usuario desafio',15,'delete_usuariodesafio'),(60,'Can view usuario desafio',15,'view_usuariodesafio');
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$870000$ShAeRpKI18dJfATIi64xkn$gDHW/tI9wb2voP2A3YTNZIDkvS/ZLcM/jDwkPcyMHBU=','2025-02-28 12:21:56.161466',1,'julio','','','julioblak36@gmail.com',1,1,'2025-02-14 17:09:40.740426'),(2,'pbkdf2_sha256$870000$tmDXMg3eJpZ4QfyS1x48tW$SxlahBfeLEfycSvDgfs9bYxgTFZI1BSTvb/fErR0zQs=',NULL,0,'anton','','','',0,1,'2025-02-15 08:29:31.720885'),(3,'pbkdf2_sha256$870000$M7LJXYnitgHVQ9Nlsfz6qA$TCBZZqt0w8h0Os308/+5QRk+h1uYTd0rs/YWWILQdQ0=',NULL,0,'MartaPardo','','','marta@cheescript.com',0,1,'2025-02-15 15:06:38.695113'),(4,'pbkdf2_sha256$870000$h3ItO84j1VjhmVfinuJFiM$LTTh/QqZHCgssutFObJTJlX0KXBlPPl+KWqPg4AeGg0=',NULL,0,'AntonioCorrea','','','antonio@cheescript.
eiEYgtEuMjllZ0Gmsf/4poU=',NULL,0,'hgdfhdd','','','fgsdfgsdfgs@outlook.com',0,1,'2025-02-18 14:16:40.349494'),(30,'pbkdf2_sha256$870000$Wi2qJIh8pj6yjiVbDB2jfC$QGkPnpR1ojV+Z8ATdWM5EXQWzK8vHKZI6ZOk4FvzwmU=',NULL,0,'antonela','','','antoneladas@gmail.com',0,1,'2025-02-18 14:21:01.438695'),(31,'pbkdf2_sha256$870000$JQYeRVv9n9CDAEk6xDxzJF$SbLFRxfJj6i6gdl57xcTfBkCblxn/scOvfkKP5gN0jI=',NULL,0,'harvarti','','','harvarti@gmail.com',0,1,'2025-02-18 14:50:08.847374'),(32,'pbkdf2_sha256$870000$2qOuPF8YdG3tti26fotE5c$jQobYo3obrPPFjOcd2oScoum2i+m3kdD8bc/sf+lhZU=',NULL,0,'asasas','','','asasas@gmail.com',0,1,'2025-02-18 15:39:41.184756'),(33,'pbkdf2_sha256$870000$8QT0N543QEPMQABCuE7Jwq$/PyoNnnm3jumKdaMZhU4hhwEest3Masin/eKWvwUbQg=',NULL,0,'asasas1','','','asasas1@gmail.com',0,1,'2025-02-18 16:26:39.323795'),(34,'pbkdf2_sha256$870000$0qJDoEvIYc2NC5DzxUXV5A$d4BFzZNKJ6VEePthcTop8aVe6z7+IQSG3yhtE0g+X4Q=',NULL,0,'antonioabad','','','antonabad5@gmail.com',0,1,'2025-02-20 16:48:59.729450'),(35,'pbkdf2_sha256$870000$3H5bopwUJijR5hUpTPqdar$NE7/CR4oOhoORNJkwXCvbpVUceQlewx73uKKKVtuR3w=',NULL,0,'queso','','','queso@gmail.com',0,1,'2025-02-27 16:16:55.554277'),(36,'pbkdf2_sha256$870000$zNw2NNaHqQ0SO0G8PE5hln$NsILaBxpHDvdlUK33CY0hAfb1ahZstG8BdXJgfgLe70=',NULL,0,'guillermo','','','guillermo12@gmail.com',0,1,'2025-02-28 14:06:37.570110'),(40,'pbkdf2_sha256$870000$nj1Mag8UzBpadujy0JR7jY$TInfnfg7wfuNGYMg2rH5QNyqVcMsNGWFoX2c/JlUcpo=',NULL,0,'borrar','','','borrar@gmail.com',0,1,'2025-03-01 11:10:31.090033'),(41,'pbkdf2_sha256$870000$5H4a0G77UT9Cm7oUXzgkXi$Pqgob+9nqihMGIlCsIJtK3p6hVrfK0upEuZ4c4R+9a8=',NULL,0,'borrar1','','','borrar1@gmail.com',0,1,'2025-03-01 20:51:17.867610');
...
INSERT INTO `django_admin_log` VALUES (1,'2025-02-15 08:29:32.389089','2','anton',1,'[{\"added\": {}}]',4,1),(2,'2025-02-15 15:51:56.234174','8','JuanAntonioGayardo',1,'[{\"added\": {}}]',4,1),(3,'2025-02-15 15:58:00.636549','13','AntonioCorrea3-0',1,'[{\"added\": {}}]',4,1),(4,'2025-02-15 15:58:09.887468','6','AntonioCorrea3-0 - 250 puntos',2,'[{\"changed\": {\"fields\": [\"Points\"]}}]',14,1),(5,'2025-02-15 16:43:38.499073','9','AntonioCorrea - 1 puntos',1,'[{\"added\": {}}]',14,1),(6,'2025-02-15 16:43:55.363169','10','PedroLacarcel - 100 puntos',1,'[{\"added\": {}}]',14,1),(7,'2025-02-15 16:44:11.807920','11','julio - 70 puntos',1,'[{\"added\": {}}]',14,1),(8,'2025-02-17 14:50:46.936847','11','julio - 70 puntos',2,'[{\"changed\": {\"fields\": [\"Profile image\"]}}]',14,1),(9,'2025-02-17 14:54:13.080634','11','julio - 70 puntos',2,'[{\"changed\": {\"fields\": [\"Profile image\"]}}]',14,1),(10,'2025-02-28 12:30:15.957695','1','Desafio cifrado 01 - teoria - Pista01',1,'[{\"added\": {}}]',12,1),(11,'2025-02-28 12:38:03.056460','2','Desafio cifrado 01 - teoria - Teoría01',1,'[{\"added\": {}}]',12,1),(12,'2025-02-28 12:52:13.021347','3','Desafio cifrado 01 - teoria - teoría01',1,'[{\"added\": {}}]',12,1),(13,'2025-02-28 16:39:01.957436','1','Desafio cifrado 01',3,'',7,1),(14,'2025-02-28 16:44:12.657573','2','Desafío de cifrado',3,'',7,1),(15,'2025-02-28 16:46:18.762184','3','Descifra la Contraseña',1,'[{\"added\": {}}]',7,1),(16,'2025-02-28 17:33:23.361499','4','El Misterio del Mensaje Perdido (Cifrado - Intermedio)',1,'[{\"added\": {}}]',7,1),(17,'2025-02-28 17:33:31.505630','4','El Misterio del Mensaje Perdido (Cifrado - Intermedio)',2,'[]',7,1),(18,'2025-03-01 09:29:38.438511','4','El Misterio del Mensaje Perdido (Cifrado - Principiante)',2,'[{\"changed\": {\"fields\": [\"Descripcion\", \"Puntuacion\", \"nivel_dificultad\"]}}]',7,1),(19,'2025-03-01 09:44:09.832799','4','El Misterio del Mensaje Perdido - teoria - Cifrado por sustitución',1,'[{\"added\": {}}]',12,1),(20,'2025-03-01 09:52:12.874652','4','El Misterio del Mensaje Perdido - teoria - Cifrado por sustitución',3,'',12,1),(21,'2025-03-01 09:53:09.944770','5','El Misterio del Mensaje Perdido - teoria - Cifrado César',1,'[{\"added\": {}}]',12,1),(22,'2025-03-01 09:54:05.930053','6','El Misterio del Mensaje Perdido - pista - Encuentra el Desplazamiento Correcto',1,'[{\"added\": {}}]',12,1),(23,'2025-03-01 10:00:27.012028','6','El Misterio del Mensaje Perdido - pista - Encuentra el Desplazamiento Correcto',2,'[]',12,1),(24,'2025-03-01 10:00:37.845915','5','El Misterio del Mensaje Perdido - teoria - Cifrado César',2,'[{\"changed\": {\"fields\": [\"Contenido\"]}}]',12,1),(25,'2025-03-01 10:01:33.358999','5','El Misterio del Mensaje Perdido - teoria - Cifrado César',2,'[{\"changed\": {\"fields\": [\"Contenido\"]}}]',12,1),(26,'2025-03-01 10:01:42.988652','5','El Misterio del Mensaje Perdido - teoria - Cifrado César',2,'[]',12,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(11,'api','comentariopublicacion'),(7,'api','desafio'),(8,'api','formulariocontacto'),(9,'api','formulariofeedback'),(14,'api','profile'),(10,'api','publicacion'),(12,'api','recursosdidacticos'),(13,'api','snippet'),(15,'api','usuariodesafio'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
INSERT INTO `django_migrations` VALUES (1,'contenttypes','0001_initial','2025-02-14 16:17:15.566537'),(2,'auth','0001_initial','2025-02-14 16:17:16.072355'),(3,'admin','0001_initial','2025-02-14 16:17:16.192606'),(4,'admin','0002_logentry_remove_auto_add','2025-02-14 16:17:16.198926'),(5,'admin','0003_logentry_add_action_flag_choices','2025-02-14 16:17:16.205317'),(6,'api','0001_initial','2025-02-14 16:17:16.827365'),(7,'contenttypes','0002_remove_content_type_name','2025-02-14 16:17:16.923029'),(8,'auth','0002_alter_permission_name_max_length','2025-02-14 16:17:16.977833'),(9,'auth','0003_alter_user_email_max_length','2025-02-14 16:17:17.014253'),(10,'auth','0004_alter_user_username_opts','2025-02-14 16:17:17.028278'),(11,'auth','0005_alter_user_last_login_null','2025-02-14 16:17:17.096337'),(12,'auth','0006_require_contenttypes_0002','2025-02-14 16:17:17.098263'),(13,'auth','0007_alter_validators_add_error_messages','2025-02-14 16:17:17.108250'),(14,'auth','0008_alter_user_username_max_length','2025-02-14 16:17:17.195823'),(15,'auth','0009_alter_user_last_name_max_length','2025-02-14 16:17:17.268873'),(16,'auth','0010_alter_group_name_max_length','2025-02-14 16:17:17.290676'),(17,'auth','0011_update_proxy_permissions','2025-02-14 16:17:17.301818'),(18,'auth','0012_alter_user_first_name_max_length','2025-02-14 16:17:17.372352'),(19,'sessions','0001_initial','2025-02-14 16:17:17.411949'),(20,'api','0002_profile','2025-02-15 14:55:04.946919'),(21,'api','0003_remove_desafio_puntuaje_desafio_puntuacion','2025-02-15 15:50:23.624553'),(22,'api','0004_profile_profile_image','2025-02-17 14:49:40.136561'),(23,'api','0005_auto_20250217_1549','2025-02-17 14:49:40.139113'),(24,'api','0006_alter_formulariocontacto_usuario','2025-02-20 16:27:30.879046'),(25,'api','0007_desafio_likes','2025-02-25 07:17:05.341826'),(26,'api','0008_remove_publicacion_likes_publicacion_likes','2025-02-25 16:59:14.238259'),(27,'api','0009_alter_comentariopublicacion_contenido_and_more','2025-02-27 16:26:49.179103'),(28,'api','0010_recursosdidacticos_nombre_and_more','2025-02-28 12:29:11.895917'),(29,'api','0011_alter_recursosdidacticos_nombre','2025-02-28 12:29:11.902944'),(30,'api','0012_desafio_clave_cifrado_desafio_codigo_base_and_more','2025-02-28 17:14:56.616790'),(31,'api','0013_remove_desafio_codigo_base_and_more','2025-02-28 17:33:13.838277'),(32,'api','0014_usuariodesafio','2025-02-28 18:14:32.369856'),(33,'api','0015_recursosdidacticos_contenido','2025-03-01 09:49:18.889731');
...
INSERT INTO `django_session` VALUES ('vmduo8nohhommxlstz74iglrbhu2g8ax','.eJxVjcsOgjAURP-layX0eVt36je4bm57SyA-QArBxPjvloSFLmfmzMybeZyn1s85jb4jdmCc7X69gPGaHmuAQ1dtKlfnOU_9_VKIY0FPG_TXbDG3pSaiROKKXEg1gHa8NkY5bKDhVGshLDmAQCg0odHaKhWsAIrgdFCSq3V0wJyXfiQ_ppwmP_XlrUzH22t5yj0CWjCGeARpFDQOQRBR7YIlE5xhny-vo0nM:1to12g:qv-ssBR8SwwIkV9vW92T8P6GQjE4eEAdUgBWHOL8MI8','2025-03-14 14:08:42.004707');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-02-14 06:43:25',NULL),('diagnostics.include_raw','OFF','2025-02-14 06:43:25',NULL),('ps_thread_trx_info.max_length','65535','2025-02-14 06:43:25',NULL),('statement_performance_analyzer.limit','100','2025-02-14 06:43:25',NULL),('statement_performance_analyzer.view',NULL,'2025-02-14 06:43:25',NULL),('statement_truncate_len','64','2025-02-14 06:43:25',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`julio`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2025-03-01 22:50:22
